...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { active: @manager.active, first_name: @manager.first_name, last_name: @manager.last_name, notes: @manager.notes, team_id: @manager.team_id }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { active: @manager.active, first_name: @manager.first_name, last_name: @manager.last_name, notes: @manager.notes, team_id: @manager.team_id }
    assert_redirected_to manager_path(assigns(:manager))
  end
